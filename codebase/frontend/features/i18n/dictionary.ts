...
export const DICTIONARY = {
  ...
  "widget.deleteConfirmTitle": { en: "Delete Widget", tr: "Bileşeni Sil" },
  "widget.deleteConfirmMessage": { en: "Are you sure you want to delete this widget? This action cannot be undone.", tr: "Bu bileşeni silmek istediğinizden emin misiniz? Bu işlem geri alınamaz." },
